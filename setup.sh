...
for package in ag atuin bat cask coreutils curl diff-so-fancy eza gh git fd ffmpeg fzf httpie jq kondo n ncdu neovim ngrok/ngrok/ngrok nvim yt-dlp/taps/yt-dlp z zsh
do
